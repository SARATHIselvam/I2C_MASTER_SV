...
module i2c_master_top (
    ...
    //======================================================================
    // Pulse Generation for Sub-modules
    //======================================================================
    assign tx_shift_pulse = shift_tx & shift_en;
    assign rx_shift_pulse = shift_rx & sample_en;
    assign counter_pulse  = counter_enable & (shift_en | sample_en);
    ...
    i2c_bus_ctrl u_bus_ctrl (
        .clk           (clk),   // Fixed: added missing clock
        .rst_n         (rst_n), // Fixed: added missing reset
